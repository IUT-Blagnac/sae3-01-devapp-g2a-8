...
- https://github.com/Sean0203[Sean Escassut]
- https://github.com/hackerB200[Eva Tubia]
- https://github.com/walaedinesekoub[Walaedine Sekoub]

Tuteur/tutrice enseignant(e) de l'équipe:: mailto:marie-francoise.canut@univ-tlse2.fr[MFC]
